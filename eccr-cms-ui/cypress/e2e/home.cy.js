...
describe('homepage', () => {
  ...
  // remote file include https://sdelements.il2.dso.mil/bunits/platform1/ecc/open-lxp-xms-ui/tasks/phase/testing/387-T122/
  ...
  // access authorized pages https://sdelements.il2.dso.mil/bunits/platform1/ecc/open-lxp-xms-ui/tasks/phase/testing/387-T84/
  // authorization https://sdelements.il2.dso.mil/bunits/platform1/ecc/open-lxp-xms-ui/tasks/phase/testing/387-T85/
  it('Check can not access restricted pages', () => {
    cy.request({
      // url: '/lists/owned',
      url: 'ecc-openlxp-xms-ui/api/catalogs',
      followRedirect: true,
  ...
  // check session https://sdelements.il2.dso.mil/bunits/platform1/ecc/open-lxp-xms-ui/tasks/phase/testing/387-T128/
  // check storage https://sdelements.il2.dso.mil/bunits/platform1/ecc/open-lxp-xms-ui/tasks/phase/testing/387-T321/
  ...
  // XSS https://sdelements.il2.dso.mil/bunits/platform1/ecc/open-lxp-xms-ui/tasks/phase/testing/387-T89/
  // check rbac https://sdelements.il2.dso.mil/bunits/platform1/ecc/open-lxp-xms-ui/tasks/phase/testing/387-T2276/
  // check authentication https://sdelements.il2.dso.mil/bunits/platform1/ecc/open-lxp-xms-ui/tasks/phase/testing/387-T2277/

  // input validation https://sdelements.il2.dso.mil/bunits/platform1/ecc/open-lxp-xms-ui/tasks/phase/testing/387-T519/
  ...
  // access local files https://sdelements.il2.dso.mil/bunits/platform1/ecc/open-lxp-xms-ui/tasks/phase/testing/387-T297/
  ...
  // null byte check https://sdelements.il2.dso.mil/bunits/platform1/ecc/open-lxp-xms-ui/tasks/phase/testing/387-T127/
  ...
  // no-cache https://sdelements.il2.dso.mil/bunits/platform1/ecc/open-lxp-xms-ui/tasks/phase/testing/387-T112/
  ...
  // check meta tag https://sdelements.il2.dso.mil/bunits/platform1/ecc/open-lxp-xms-ui/tasks/phase/testing/387-T132/
  ...
  // check CSP https://sdelements.il2.dso.mil/bunits/platform1/ecc/open-lxp-xms-ui/tasks/phase/testing/387-T332/
  // it('Check meta tags', () => {
