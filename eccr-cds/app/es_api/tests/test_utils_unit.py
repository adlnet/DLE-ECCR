...
class UtilTests(TestCase):
    ...
    def test_get_results(self):
        ...
        with patch('elasticsearch.dsl.response') as response_obj:
            response_obj.hits.total.value = 1
            response_obj.aggregations.to_dict.return_value = {}
            query = XSEQueries('https://test:9200', 'test')
    ...
    def test_more_like_this(self):
        """"Test that calling more_like_this returns whatever response elastic\
              search returns"""
        with patch('elasticsearch.dsl.Search.execute') as es_execute, \
    ...
    def test_search_by_keyword_error(self):
        ...
        with patch('es_api.utils.queries.'
                ...
                patch('elasticsearch.dsl.Search.execute') as es_execute, \
...
class XDSUserTests(TestCase):
    ...
    def test_user_org_filter_custom_user(self):
        ...
        query = XSEQueries('https://test:9200', 'test', user=user)
